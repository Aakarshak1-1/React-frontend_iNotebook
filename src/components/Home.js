    ...
    <>
        ...
        <div className="container" onClick={BodyMode}>
          <div className="container d-flex justify-content-center my-5">
            {!note_flag && (
              <div
                className="text-center d-flex justify-content-center align-items-center form-control border border-1 border-primary"
            ...
            {note_flag && (
              <div
                className="text-center d-flex flex-column justify-content-center align-items-start form-control border border-1 border-primary"
                style={{ width: "600px" }}
              >
                ...
                <div className="d-flex align-items-center">
                  ...
                  <button
                    ...
                    onClick={NoteMode}
                    disabled={
                      addingNote.title.length < 5 ||
                      addingNote.description.length < 5
                    }
                  >
                    Close
                  </button>
